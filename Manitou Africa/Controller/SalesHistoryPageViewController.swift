//
//  SalesHistoryPageViewController.swift
//  Manitou Africa
//
...
class SalesHistoryPageViewController: UIPageViewController, UIPageViewControllerDataSource {
    
    lazy var viewControllerList: [UIViewController] = {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let vc1 = storyboard.instantiateViewController(withIdentifier: "SalesHistoryFirstController")
        let vc2 = storyboard.instantiateViewController(withIdentifier: "SalesHistorySecondController")
