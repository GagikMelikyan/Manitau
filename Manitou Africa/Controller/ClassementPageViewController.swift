//
//  ClassementPageViewController.swift
//  Manitou Africa
//
...
class ClassementPageViewController: UIPageViewController, UIPageViewControllerDataSource {
    
    lazy var viewControllerList: [UIViewController] = {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let vc1 = storyboard.instantiateViewController(withIdentifier: "ClassementFirstController")
        let vc2 = storyboard.instantiateViewController(withIdentifier: "ClassementSecondController")
