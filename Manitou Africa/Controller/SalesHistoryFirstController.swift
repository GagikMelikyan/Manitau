//
//  SalesHistoryFirstController.swift
//  Manitou Africa
//
...
class SalesHistoryFirstController: BaseWebViewController {
    ...
    override func webViewLoadFunction() {
        ...
        if let value = UserDefaults.standard.object(forKey: "valuesSalesFirst") ?? UserDefaults.standard.object(forKey: "firstValueDropDownCode") {
            if let url = URL(string: URL_BASE + "/" + API_VERSION + "/sales/2019?cid=\(id)&code=\(value)") {
                print(url)
    ...
    override func updateLabelsText() {
        ...
        subtitleLabel.text = "mySales2019".localized
    }
}
